...
window.CityUI = (function () {
  ...
  function openBuilding(building) {
    ...
    const vcEl = document.getElementById("visited-count");
    if (vcEl) vcEl.textContent = `${visited} / ${total} VISITED`;
  ...
  function updateHUD(speed) {
    ...
    if (gearEl)
      gearEl.textContent = speed > 0.015 ? "D" : speed < -0.015 ? "R" : "N";
  }
